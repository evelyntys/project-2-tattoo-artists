...
export default class AddNewArtist extends React.Component {
    ...
    validateFirstPage = () => {
        ...
        console.log(this.ValidationChecker("artist name", this.state.artistName))
        console.log(this.ValidationChecker("year",this.state.yearStarted))
        console.log(this.ValidationChecker("general-checkbox", this.state.method))
        console.log(this.ValidationChecker("general-checkbox",this.state.ink))
        console.log(this.ValidationChecker("style", this.state.style))
        console.log(this.ValidationChecker("contact", this.state.contact))
        console.log(this.ValidationChecker("general", this.state.image))
        let validation =
